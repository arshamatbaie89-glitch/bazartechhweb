                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
                      <div>
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <a href="https://api.whatsapp.com/send?phone=96897484837" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full bg-gray-800 hover:bg-yellow-500 hover:text-gray-900 flex items-center justify-center transition-all hover:scale-110" aria-label="WhatsApp">
                      ...
                      <div>
                        ...
                        <div className="space-y-2 text-sm">
                          ...
                          <p>Phone: <a href="https://api.whatsapp.com/send?phone=96897484837" className="hover:text-white transition-colors">+968 9748 4837</a></p>
